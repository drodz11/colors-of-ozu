...
![Still from An Autumn Afternoon](https://github.com/drodz11/colors-of-ozu/blob/master/_includes/image/aaa_square0090.jpg)

If, however, we run the command without the `"scale"` option, our stills will look like this:

![Still from An Autumn Afternoon without pixel scaling](https://github.com/drodz11/colors-of-ozu/blob/master/_includes/image/aaa_0090.jpg)
